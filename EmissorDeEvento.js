...
class Execucao {
    ...
    #estado = {
        ...
        isJaExecutou: false,
        /**
         * Se o parametro de exclusão apos ms for definido, contem o ID do settimeout que executa o cancelamento
         */
    ...
    constructor(evento, id, callback, parametros) {
        ...
        if (parametros != undefined) {
            ...
            if (parametros.expirarAposMs != undefined) {
                ...
                this.#parametros.expiracaoCallback.tempoMs = parametros.expirarAposMs;
